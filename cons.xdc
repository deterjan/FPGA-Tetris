...
# LEDs
#set_property PACKAGE_PIN U16 [get_ports {buttOut}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buttOut}]
...
#Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {butt}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {butt}]
##Sch name = JB3
